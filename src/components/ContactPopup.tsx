...
export default function ContactPopup({ isOpen, onClose }: ContactPopupProps) {
  ...
  const contactInfo = [
    ...
    {
      path: <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>,
      label: 'Email',
      value: 'depanwita.dey@gmail.com',
      link: '#'
    },
    {
      ...
      label: 'GitHub',
      value: 'github.com/depanwita-dey',
      link: '#'
    }
  ]
        ...
        <div className="bg-[#2E2D2D] border border-[#A59ADB]/20 rounded-lg shadow-xl max-w-md w-full mx-4">
          ...
          <div className="p-6 space-y-6">
            {contactInfo.map((element, index)=>{
              ...
              <div>
                <p className="text-sm text-gray-400">{element.label}</p>
                <Link href={element.link} className="text-white font-medium hover:text-[#CE4DDB]">{element.value}</Link>
              </div>
              </div>)
            })}
            {/* Mobile Number */}
            {/* <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <Link href="#" className="text-white font-medium hover:text-[#CE4DDB]">+91 62******27</Link>
              </div>
            </div> */}
            ...
            {/* <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <Link href="#" className="text-white font-medium  hover:text-[#CE4DDB]">depanwita.dey@gmail.com</Link>
              </div>
            </div> */}
            ...
            {/* <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <Link href="#" className="text-white font-medium  hover:text-[#CE4DDB]">github.com/depanwita-dey</Link>
              </div>
            </div> */}
          </div>
